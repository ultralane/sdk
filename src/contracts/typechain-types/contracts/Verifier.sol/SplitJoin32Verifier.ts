...
export interface SplitJoin32VerifierInterface extends Interface {
  getFunction(
...
export interface SplitJoin32Verifier extends BaseContract {
  connect(runner?: ContractRunner | null): SplitJoin32Verifier;
  waitForDeployment(): Promise<this>;

  interface: SplitJoin32VerifierInterface;
