...
export interface NoteVerifierInterface extends Interface {
  getFunction(
...
export interface NoteVerifier extends BaseContract {
  connect(runner?: ContractRunner | null): NoteVerifier;
  waitForDeployment(): Promise<this>;

  interface: NoteVerifierInterface;
