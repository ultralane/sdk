...
export interface SplitJoin16VerifierInterface extends Interface {
  getFunction(
...
export interface SplitJoin16Verifier extends BaseContract {
  connect(runner?: ContractRunner | null): SplitJoin16Verifier;
  waitForDeployment(): Promise<this>;

  interface: SplitJoin16VerifierInterface;
