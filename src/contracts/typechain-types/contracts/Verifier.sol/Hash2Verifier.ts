...
export interface Hash2VerifierInterface extends Interface {
  getFunction(
...
export interface Hash2Verifier extends BaseContract {
  connect(runner?: ContractRunner | null): Hash2Verifier;
  waitForDeployment(): Promise<this>;

  interface: Hash2VerifierInterface;
