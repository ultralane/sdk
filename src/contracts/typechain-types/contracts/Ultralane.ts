...
export interface UltralaneInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "INIT_CODE_HASH"
      | "ROOT_HISTORY_SIZE"
...
export interface Ultralane extends BaseContract {
  connect(runner?: ContractRunner | null): Ultralane;
  waitForDeployment(): Promise<this>;

  interface: UltralaneInterface;
